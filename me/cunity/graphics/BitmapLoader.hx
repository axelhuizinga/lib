...
class BitmapLoader extends Loader
{
	...
	var _onCompleteCallback:DisplayObject -> Void;
	var _img:Dynamic;
	...
	function getBitmapData(content:DisplayObject) {
		...
		//bData = new BitmapData(Std.int(content.width), Std.int(content.height), true, 0x00000000);
		var mat:Matrix = new Matrix();
		bData.draw(content, mat, null, BlendMode.NORMAL, null, true);
		//bData.draw(content, mat, null, BlendMode.LAYER, null, true);
	}
